		...
		toFixed: function(num){
          ...
          this.form["purchase_date"] = this.$toTime(parseInt(this.form["purchase_date"]),"yyyy-MM-dd")
			...
			get_obj_after(json, func){
																																														...
																																														if(json.result.obj["purchase_date"]=="0000-00-00"){
				  json.result.obj["purchase_date"] = null;
				}
				if(parseInt(json.result.obj["purchase_date"]) > 9999){
					json.result.obj["purchase_date"] = this.$toTime(parseInt(json.result.obj["purchase_date"]),"yyyy-MM-dd")
				}
