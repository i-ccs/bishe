      ...
      <el-table-column sortable prop="update_time" label="更新时间" min-width="200">
        <template slot-scope="scope">
          {{ $toTime(scope.row["update_time"],"yyyy-MM-dd hh:mm:ss") }}
                ...
                <el-table-column fixed="right" label="操作" min-width="120" v-if="$check_action('/sales_information/table','set') || $check_action('/sales_information/view','set') || $check_action('/sales_information/view','get')
					 ">
      ...
      <template slot-scope="scope">
        <router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
          ...
          <span>详情</span>
                                              ...
                                              <el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small" @click="openPayModal(scope.row)" v-if="scope.row.pay_state==='未支付' && ($check_pay('/sales_information/table'))">
              <span>支付</span>
            </el-button>
                                            		  		        </template>
    </el-table-column>
