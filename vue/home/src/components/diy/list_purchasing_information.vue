<template>
	<div class="diy_home diy_list diy_purchasing_information" id="diy_purchasing_information_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/purchasing_information/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
