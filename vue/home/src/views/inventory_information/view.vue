				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<view_inventory_information v-if="$check_action('/inventory_information/view','get')"></view_inventory_information>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_inventory_information from "../../components/diy/view_inventory_information.vue";
	export default {
		data() {
			return {
			};
