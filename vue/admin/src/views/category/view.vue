<template>
	<el-main class="bg edit_wrap category">
...
<!--<el-col :xs="24" :sm="12" :lg="6" class="el_form_item_warp">
			...
			<el-col :xs="24" :sm="24" :lg="24" class="el_form_btn_warp">
				<el-form-item>
					<el-col v-if="(form['type_id'] && $check_action('/category/view','set')) || (!form['type_id'] && $check_action('/category/view','add'))" :xs="24" :sm="12" :lg="12" class="el_form_btn el_form_btn_1">
...
<script>
	...
	export default {
		...
		data() {
			return {
				field: "type_id",
				url_add: "~/api/category/add?",
				url_set: "~/api/category/set?",
				url_get_obj: "~/api/category/get_obj?",
				url_upload: "~/api/category/upload?",
