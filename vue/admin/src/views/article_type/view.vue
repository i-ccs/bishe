...
<!--<el-col :xs="24" :sm="12" :lg="6" class="el_form_item_warp">
			...
			<el-col :xs="24" :sm="24" :lg="24" class="el_form_btn_warp">
				<el-form-item>
					<el-col v-if="(form['type_id'] && $check_action('/article_type/view','set')) || (!form['type_id'] && $check_action('/article_type/view','add'))" :xs="24" :sm="12" :lg="12" class="el_form_btn el_form_btn_1">
