		...
		<el-form label-position="right" :model="query" class="form p_4" label-width="120">
			...
			<el-row class="rows row2" type="flex" justify="center">
				<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap" style="text-align: center;">
					...
					<el-button v-if="$check_action('/comment/table','del')" class=" search_btn_del" type="danger" @click="delInfo()">删除</el-button>
				</el-col>
			</el-row>
		</el-form>
		...
		<el-table border :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%; table-layout: fixed;" stripe>
			...
			<el-table-column fixed="right" label="操作" align="center">
				<template slot-scope="scope">
					...
					<!--<router-link v-if="!scope.row['reply_to_id']" class="el-button el-button&#45;&#45;small is-plain el-button&#45;&#45;primary" :to="'./view?reply_to_id=' + scope.row[field]" size="small">
						回复
					</router-link>-->
