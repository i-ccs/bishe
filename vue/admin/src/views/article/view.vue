	...
	<el-main class="bg edit_wrap article">
		<el-form ref="form" :model="form" status-icon label-width="70px">
			...
			<el-col :xs="24" :sm="24" :lg="24" class="el_form_btn_warp">
				<el-form-item>
					<el-col v-if="(form['article_id'] && $check_action('/article/view','set')) || (!form['article_id'] && $check_action('/article/view','add'))" :xs="24" :sm="12" :lg="12" class="el_form_btn el_form_btn_1">
