<template>
	<el-main class="bg edit_wrap comtable_e">
		...
		<el-row class="row_ce"> 
							<el-col v-if="can_show_field('supplier_name')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
					...
					<div v-else>{{form['supplier_name']}}</div>
											</el-form-item>
			</el-col>
							<el-col v-if="can_show_field('suppliers_phone_number')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
						...
						v-if="can_edit_field('suppliers_phone_number')">
					</el-input>
					...
					<div v-else>{{form['comprehensive_evaluation']}}</div>
											</el-form-item>
			</el-col>
							<el-col v-if="can_show_field('supply_frequency')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
					...
					<div v-else>{{form['supply_frequency']}}</div>
											</el-form-item>
			</el-col>
							<el-col v-if="can_show_field('supply_products')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
					...
					<div v-else>{{form['supply_products']}}</div>
							</el-form-item>
			</el-col>
							<el-col v-if="can_show_field('product_quality')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
					...
					<div v-else>{{form['product_quality']}}</div>
							</el-form-item>
			</el-col>
							<el-col v-if="can_show_field('cooperation_situation')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
					...
					<div v-else>{{form['cooperation_situation']}}</div>
							</el-form-item>
			</el-col>
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_btn_warp">
				<el-form-item v-if="$check_action('/supply_information/table','set') || $check_action('/supply_information/table','add') || $check_action('/supply_information/view','set') || $check_action('/supply_information/view','add')">
