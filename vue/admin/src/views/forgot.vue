        ...
        <el-col>
          <el-form :model="form" ref="form" label-width="80px" class="form">
            ...
            <el-form-item label="用户名" prop="usr_name">
              <el-input v-model="form.usr_name" placeholder="请输入用户名"></el-input>
            </el-form-item>
  ...
  export default {
    ...
    methods: {
      send() {
        ...
        let _this = this;
        _this.$get('~/api/user/get_obj', {"usr_name": _this.form.usr_name}, function (user_json, status) {
      ...
      async submit_check(param) {
        ...
        var {usr_name, email, password, code} = param;
