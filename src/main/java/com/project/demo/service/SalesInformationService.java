...
/**
 * 销售信息表服务类
 * 用于处理销售信息的数据查询、统计等业务逻辑
 * 主要功能包括：查询销售信息、统计记录数、分组统计等
 *
 * @author project
 * @version 1.0
 */
@Service
public class SalesInformationService extends BaseService<SalesInformation> {
    ...
    public String select(Map<String, String> query, Map<String, String> config) {
        ...
        // 如果未指定查询字段，则使用默认字段（销售信息字段+商品信息关键字段）
