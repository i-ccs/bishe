...
/**
 * 采购信息：(PurchasingInformation)表服务接口
 *
 */
@Service
public class PurchasingInformationService extends BaseService<PurchasingInformation> {
    ...
    public String select(Map<String, String> query, Map<String, String> config) {
        ...
        sql.append(config.get(FindConfig.FIELD) == null || "".equals(config.get(FindConfig.FIELD)) ? "a.*, b.product_name, b.product_category, b.product_brand, b.commodity_specifications"
        ...
        if (query.size() > 0) {
            try {
                ...
                for (Map.Entry<String, String> entry : query.entrySet()) {
                    ...
                    String alias = "a.";
                    if (field.equals("product_name") || field.equals("product_category") || field.equals("product_brand") || field.equals("commodity_specifications")) {
                        alias = "b.";
                    }
    ...
    public String selectGroupCount(Map<String, String> query, Map<String, String> config) {
        ...
        if (groupBy.equals("product_name") || groupBy.equals("product_category") || groupBy.equals("product_brand") || groupBy.equals("commodity_specifications")) {
