...
public interface CategoryMapper extends BaseMapper<Category> {
     ...
     */
    Category selectCategoryById(Integer typeId);
     ...
     */
    List<Category> selectCategoryList(Category articleType);
     ...
     * @return 结果
     */
    int insertCategory(Category articleType);
     ...
     * @return 结果
     */
    int updateCategory(Category articleType);
     ...
     * @return 结果
     */
    int deleteCategoryById(Integer typeId);
     ...
     * @return 结果
     */
    int deleteCategoryByIds(Integer[] typeIds);
}
