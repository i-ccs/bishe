...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='收藏';

-- ----------------------------
-- Records of collect
-- ----------------------------
BEGIN;
INSERT INTO `collect` (`collect_id`, `user_id`, `source_table`, `source_field`, `source_id`, `title`, `img`, `create_time`, `update_time`) VALUES (4, 1, 'commodity_information', 'commodity_information_id', 21, 'shangpi1', '/api/upload/O1CN01EBbQPP1q2CWxm7wtb_!!4611686018427385277-0-item_pic.jpg_460x460q90.jpg_.webp', '2026-05-05 00:55:56', '2026-05-05 00:55:56');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `comment` (`comment_id`, `user_id`, `reply_to_id`, `content`, `nick_name`, `avatar`, `create_time`, `update_time`, `source_table`, `source_field`, `source_id`, `is_delete`) VALUES (2, 1, 0, '<p>用</p>', 'admin', '/api/upload/admin_avatar.jpg', '2026-05-03 17:51:17', '2026-05-03 17:51:17', 'article', 'article_id', 7, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `inventory_information` (`inventory_information_id`, `product_code`, `product_inventory`, `check_date`, `check_quantity`, `inventory`, `create_time`, `update_time`, `source_table`, `source_id`, `source_user_id`, `is_delete`, `version`) VALUES (13, '1777695462707', 0.00, '2026-05-03', 3.00, '', '2026-05-03 12:51:43', '2026-05-03 12:51:43', 'commodity_information', 21, 1, 0, 0);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='点赞';

-- ----------------------------
-- Records of praise
-- ----------------------------
BEGIN;
INSERT INTO `praise` (`praise_id`, `user_id`, `create_time`, `update_time`, `source_table`, `source_field`, `source_id`, `status`) VALUES (6, 1, '2026-05-05 00:55:55', '2026-05-05 00:55:55', 'commodity_information', 'commodity_information_id', 21, 1);
INSERT INTO `praise` (`praise_id`, `user_id`, `create_time`, `update_time`, `source_table`, `source_field`, `source_id`, `status`) VALUES (7, 1, '2026-05-05 00:56:12', '2026-05-05 00:56:12', 'article', 'article_id', 8, 1);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `purchasing_information` (`purchasing_information_id`, `product_code`, `commodity_price`, `purchase_order_number`, `supplier_name`, `purchase_date`, `purchase_quantity`, `purchase_unit_price`, `total_purchase_price`, `procurement_status`, `create_time`, `update_time`, `source_table`, `source_id`, `source_user_id`, `is_delete`) VALUES (13, '1777695462707', 3.00, '1777783588309', 'gw', '2026-05-03', 2.00, 4.00, 8.00, '', '2026-05-03 12:46:42', '2026-05-03 16:16:07', 'commodity_information', 21, 1, 0);
INSERT INTO `purchasing_information` (`purchasing_information_id`, `product_code`, `commodity_price`, `purchase_order_number`, `supplier_name`, `purchase_date`, `purchase_quantity`, `purchase_unit_price`, `total_purchase_price`, `procurement_status`, `create_time`, `update_time`, `source_table`, `source_id`, `source_user_id`, `is_delete`) VALUES (15, '1777879472353', 5.00, '1777884772063', 'gw', '2026-05-04', 3.00, 1.00, 3.00, '', '2026-05-04 16:53:22', '2026-05-04 16:53:22', 'commodity_information', 23, 1, 0);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='注册用户';

-- ----------------------------
-- Records of registered_user
-- ----------------------------
BEGIN;
INSERT INTO `registered_user` (`registered_user_id`, `user_id`, `user_name`, `user_gender`, `state`, `examine_state`, `is_delete`, `create_time`, `update_time`) VALUES (5, 7, 'null', NULL, 1, '已通过', 0, '2026-05-05 01:50:10', '2026-05-05 01:50:10');
INSERT INTO `registered_user` (`registered_user_id`, `user_id`, `user_name`, `user_gender`, `state`, `examine_state`, `is_delete`, `create_time`, `update_time`) VALUES (6, 9, 'rregr', 0, 1, '已通过', 0, '2026-05-05 01:55:57', '2026-05-05 01:57:42');
INSERT INTO `registered_user` (`registered_user_id`, `user_id`, `user_name`, `user_gender`, `state`, `examine_state`, `is_delete`, `create_time`, `update_time`) VALUES (7, 10, 'refed', 1, 1, '已通过', 0, '2026-05-05 01:58:50', '2026-05-05 01:58:50');
INSERT INTO `registered_user` (`registered_user_id`, `user_id`, `user_name`, `user_gender`, `state`, `examine_state`, `is_delete`, `create_time`, `update_time`) VALUES (8, 5, 'flsde', NULL, 1, '已通过', 0, '2026-05-05 02:04:49', '2026-05-05 02:04:49');
INSERT INTO `registered_user` (`registered_user_id`, `user_id`, `user_name`, `user_gender`, `state`, `examine_state`, `is_delete`, `create_time`, `update_time`) VALUES (9, 6, 'fergre', NULL, 1, '已通过', 0, '2026-05-05 02:04:49', '2026-05-05 02:04:49');
INSERT INTO `registered_user` (`registered_user_id`, `user_id`, `user_name`, `user_gender`, `state`, `examine_state`, `is_delete`, `create_time`, `update_time`) VALUES (10, 8, 'wefwe', NULL, 1, '已通过', 0, '2026-05-05 02:04:49', '2026-05-05 02:04:49');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `sales_information` (`sales_information_id`, `product_code`, `commodity_price`, `sales_order_number`, `registered_user`, `user_name`, `order_quantity`, `total_order_price`, `note_information`, `pay_state`, `pay_type`, `create_time`, `update_time`, `source_table`, `source_id`, `source_user_id`, `is_delete`) VALUES (13, '1777778101568', 9.90, '1777781893946', 1, '', 0.00, 0.00, '', '未支付', '', '2026-05-03 12:18:51', '2026-05-03 12:18:51', 'commodity_information', 22, 1, 0);
INSERT INTO `sales_information` (`sales_information_id`, `product_code`, `commodity_price`, `sales_order_number`, `registered_user`, `user_name`, `order_quantity`, `total_order_price`, `note_information`, `pay_state`, `pay_type`, `create_time`, `update_time`, `source_table`, `source_id`, `source_user_id`, `is_delete`) VALUES (14, '1777778101568', 9.90, '1777781953713', 3, '用户姓名2', 4.00, 39.60, '', '未支付', '', '2026-05-03 12:19:15', '2026-05-03 15:33:43', 'commodity_information', 22, 1, 0);
INSERT INTO `sales_information` (`sales_information_id`, `product_code`, `commodity_price`, `sales_order_number`, `registered_user`, `user_name`, `order_quantity`, `total_order_price`, `note_information`, `pay_state`, `pay_type`, `create_time`, `update_time`, `source_table`, `source_id`, `source_user_id`, `is_delete`) VALUES (15, '1777778101568', 9.90, '1777795526318', 2, '用户姓名1', 3.00, 29.70, '', '已支付', '微信', '2026-05-03 16:05:30', '2026-05-03 16:13:59', 'commodity_information', 22, 2, 0);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `supply_information` (`supply_information_id`, `supplier_name`, `suppliers_phone_number`, `commodity_category`, `comprehensive_evaluation`, `supply_frequency`, `supply_products`, `product_quality`, `cooperation_situation`, `create_time`, `update_time`, `is_delete`) VALUES (15, 'gw', '13658528542', '零食', '', '一 天一次', '', '', '', '2026-05-02 12:20:06', '2026-05-04 22:37:05', 0);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='用户账户';
...
INSERT INTO `user_group` (`group_id`, `display`, `name`, `description`, `source_table`, `source_field`, `source_id`, `register`, `create_time`, `update_time`) VALUES (3, 100, '注册用户', NULL, 'registered_user', '', 0, 3, '2025-05-18 11:51:28', '2026-05-05 01:47:38');
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='用户点击';
...
INSERT INTO `views` (`views_id`, `user_id`, `create_time`, `update_time`, `source_table`, `source_field`, `source_id`) VALUES (47, 1, '2026-05-05 00:55:36', '2026-05-05 00:55:36', 'commodity_information', 'commodity_information_id', 23);
INSERT INTO `views` (`views_id`, `user_id`, `create_time`, `update_time`, `source_table`, `source_field`, `source_id`) VALUES (48, 1, '2026-05-05 00:55:52', '2026-05-05 00:55:52', 'commodity_information', 'commodity_information_id', 21);
COMMIT;
